...
if uploaded_file is not None:
    try:
        ...
        if len(df.columns) >= 2:
            fig_bar = px.bar(df, x=df.columns, y=df.columns, title="Live Comparison Analysis")
...
with p_col1:
    st.markdown('<div class="pricing-card"><div class="feature-title" style="font-size:1.4rem;">Starter</div><div class="feature-text">For individuals starting out</div><div style="font-size:2.2rem; font-weight:bold; margin:1rem 0; color:#FFF;">$0</div><div class="feature-text" style="text-align:left; margin-left:15%;">✓ 5 dashboards<br>✓ Basic processing</div></div>', unsafe_html_allowed=True)
